...
#define gtc()  if(kbhit()) oldc=(oldc==(ooc=getch())?'\0':ooc);else oldc='\0'
#define        gtch()  (oldc)
...
#else
 for (i=0;j<0xFFFF;j++);               /*loop a while*/
#endif
